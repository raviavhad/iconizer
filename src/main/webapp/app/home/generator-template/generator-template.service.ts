...
export class GeneratorTemplateService {
    ...
    download(jhipsterConfigurationModel: JHipsterConfigurationModel): Observable<HttpResponse<Blob>> {
        return this.http.post(
            'api/download-template-application',
    ...
    generateOnGit(
        ...
        return this.http.post(
            'api/generate-template-application',
            {
                'generator-jhipster': jhipsterConfigurationModel,
    ...
    getGenerationData(applicationId: string): Observable<string> {
        return this.http.get('api/generate-template-application/' + applicationId, { responseType: 'text' });
    }
}
