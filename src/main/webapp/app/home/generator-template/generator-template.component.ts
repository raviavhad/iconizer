...
@Component({
    ...
    templateUrl: './generator-template.component.html',
    styleUrls: ['generator-template.scss']
})
export class GeneratorTemplateComponent implements OnInit {
    ...
    constructor(
        ...
        private generatorService: GeneratorTemplateService,
    ...
    ngOnInit() {
        this.languageOptions = GeneratorTemplateComponent.getAllSupportedLanguageOptions();
