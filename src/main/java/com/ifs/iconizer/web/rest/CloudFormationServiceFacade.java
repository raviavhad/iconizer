 ...
 */
public class CloudFormationServiceFacade {
	...
	public void createCICDStack(String projectName, String template) {

		System.out.println("===========================================");
		System.out.println("Getting Started with AWS CloudFormation");
		System.out.println("===========================================\n");

		String stackName = projectName+"Stack";
		...
		try {
			...
			System.out.println("Template path:" + "C:\\work\\workspace\\jhipster\\IconizerExport\\"+projectName+"\\CloudFormation.template");
		/*	createRequest.setTemplateBody(convertStreamToString(
					CloudFormationServiceFacade.class.getResourceAsStream("C:\\work\\workspace\\jhipster\\IconizerExport\\"+projectName+"\\CloudFormation.template")));
		*/	createRequest.setTemplateBody(template);
			...
			// Note that you could use SNS notifications on the CreateStack call
			// to track the progress of the stack creation
			System.out.println("Stack creation completed, the stack " + stackName + " completed with "
					+ waitForCompletion(stackbuilder, stackName));

			// Show all the stacks for this account along with the resources for
			// each stack
			...
			System.out.println("Error Message: " + ace.getMessage());
			 ...
			 System.out.println("Caught an Unknown exception, which means the client encountered "
						+ "a serious internal problem while trying to communicate with AWS CloudFormation, "
						+ "such as not being able to access the network.");
	...
	public void deleteStack(String projectName) {
		
		String stackName = "IconizerCICDStack" + projectName;
		try {
			// Delete the stack
			...
			// Note that you could used SNS notifications on the original
			// CreateStack call to track the progress of the stack deletion
			System.out.println("Stack creation completed, the stack " + stackName + " completed with "
					+ waitForCompletion(stackbuilder, stackName));
	...
	public static void main(String[] args) throws Exception {
		...
		//cloudFormationService.createCICDStack("P1");
	...
	public void createWorkspaceStack(String projectName, String template) {

		System.out.println("===========================================");
		System.out.println("Getting Started with AWS CloudFormation - Workspace Creation");
		System.out.println("===========================================\n");
		...
		try {
			...
			//System.out.println("Template path:" + "C:\\work\\workspace\\jhipster\\IconizerExport\\"+projectName+"\\workspace.vm");
		/*	createRequest.setTemplateBody(convertStreamToString(
					CloudFormationServiceFacade.class.getResourceAsStream("C:\\work\\workspace\\jhipster\\IconizerExport\\"+projectName+"\\CloudFormation.template")));
		*/	createRequest.setTemplateBody(template);
